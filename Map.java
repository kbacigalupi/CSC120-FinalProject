...
public class Map {
    ...
    Location emptyCamp2 ) {
        ...
        .putEdge(sawCamp, butterCamp)
        .putEdge(butterCamp, portageStart)
        .putEdge(portageStart, flourCamp)
        ...
        .putEdge(sugarCamp, emptyCamp1)
        .putEdge(emptyCamp1, finalCamp)
        .putEdge(finalCamp, panCamp)
        .putEdge(panCamp, cinnamonCamp)
        .putEdge(cinnamonCamp, emptyCamp2)
